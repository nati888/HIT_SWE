...
public class Excel {
    ...
    public static void add_Worker_To_Excel(sample.model.Worker new_worker) {
        ArrayList<String> A = new ArrayList<>();
        String excelFilePath = "Workers_data.xlsx";
        sample.model.Departement dp;
    ...
    public static void fired_Workers_Excel(sample.model.Worker worker){
        ArrayList<String> A = new ArrayList<>();
