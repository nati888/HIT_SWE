...
public class Worker extends Person {
    ...
    public Worker(String last_name, String first_name, int ID, String mail,int department_id, int Job_ID, float experience, float base_salary, float hours, ArrayList<String> assessment,String user_name, String password) {
